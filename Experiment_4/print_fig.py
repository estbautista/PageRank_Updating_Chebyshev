...
data_pr = np.load('Res_Fig4_stdPR.npz')
...
ax0.plot(np.arange(1, len(error_update)+1), error_update, label='Update', linestyle='solid', marker='None', color='tab:red', markersize=6, linewidth=3, markerfacecolor='None', markeredgewidth=2)
...
plt.savefig('fig4_stdpr', dpi=300, edgecolor='w',bbox_inches="tight")
